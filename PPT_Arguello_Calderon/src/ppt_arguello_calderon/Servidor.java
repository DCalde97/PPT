...
public class Servidor {
    ...
    */ 
    private static String recNick(Socket sck){
        ...
        /**
        * Variable que almacena el resultado de comprobar un nick para que no
        * se repita si ya hay un jugador con ese mismo.
        */ 
    ...
    */ 
    public static void Retransmitir(String elmensaje) {
        /**
         * Almacena el mensaje separado por el token @
         */
